...
import oopsucks.model.TuitionFee;
import oopsucks.model.TuitionFeeDAO;
import oopsucks.model.UserDAO;
import oopsucks.model.ClazzDAO; // Thêm ClazzDAO để truy vấn clazz_student
import javax.swing.*;
...
public class CreditStudentTuitionFeePanel extends JPanel {
    private final String studentID;
    private final JPanel cardPanel;
    private final CardLayout cardLayout;
    private final TuitionFeeDAO tuitionFeeDAO;
    private final UserDAO userDAO;
    private final ClazzDAO clazzDAO; // Thêm ClazzDAO
    private final JTable tuitionTable;
    private final DefaultTableModel tableModel;
    private final JLabel messageLabel;

    public CreditStudentTuitionFeePanel(String studentID, JPanel cardPanel, CardLayout cardLayout, TuitionFeeDAO tuitionFeeDAO, UserDAO userDAO) {
        this.studentID = studentID;
        this.cardPanel = cardPanel;
        this.cardLayout = cardLayout;
        this.tuitionFeeDAO = tuitionFeeDAO;
        this.userDAO = userDAO;
        this.clazzDAO = new ClazzDAO(); // Khởi tạo ClazzDAO
    ...
    private void initializeUI() {
        ...
        String[] columnNames = {
            "Kỳ học", "Số tín chỉ học phí", "Phí tín chỉ", "Tổng học phí", "Trạng thái thanh toán"
        };
    ...
    private void loadTuitionFeeData() {
        ...
        for (int semester : registeredSemesters) {
            TuitionFee fee = tuitionFeeDAO.calculateAndSaveTuitionFee(studentID, semester);
            if (fee != null) {
                hasData = true;
            }
        }
